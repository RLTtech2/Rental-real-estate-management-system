...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
                                    ...
                                    <div class="inbox-center">
                                            <?php  
                                                        ...
                                                        elseif (isset($_GET["del_error"])) {
                                                            $error_msg = "There was an error during deleting this record. Please try again.";
                                                            if ($_GET["del_error"] == "invalid_id") {
                                                                $error_msg = "Invalid post ID provided.";
                                                            } elseif ($_GET["del_error"] == "database_error") {
                                                                $error_msg = "Database error occurred. Please try again.";
                                                            } elseif ($_GET["del_error"] == "no_id") {
                                                                $error_msg = "No post ID provided.";
                                                            }
                                                            echo 
                                                            '<div class="alert alert-danger" >
                                                                  <a href="#" class="close" data-dismiss="alert" aria-label="close"></a>
                                                                 <strong>ERROR!! </strong><p> ' . $error_msg . '</p>
                                                            </div>'
                                                            ;
                                                        }                                                        
                                                        ?>
                                        <table class="table table-hover">
                                            ...
                                            <thead>
                                                <tr>
                                                    <th><h4>Recent Blog Posts (<b style="color: orange;"><?php echo mysqli_num_rows($query);?></b>)</h4>
                                                        <?php 
                                            ...
                                            <tbody>
                                             <?php
                                              ...
                                              '<tr>
                                                    ...
                                                    <td class="max-texts">'.$truncated_content.'</td>
                                                    <td class="text-right">'.$row["date"].'</td>
                                                    <td class="text-right">
                                                        <a href="edit-post.php?id='.$row["id"].'" class="btn btn-warning btn-sm">
                                                            <i class="fa fa-edit"></i> Edit
                                                        </a>
                                                        <button onclick="confirmDelete('.$row["id"].', \''.htmlspecialchars($row["title"]).'\')" class="btn btn-danger btn-sm">
            ...
            <!-- /.container-fluid -->
            <p class="copyright">
        <!---getting the current year with javascript-->
    ...
    function confirmDelete(postId, postTitle) {
        if (confirm('Are you sure you want to delete the post "' + postTitle + '"?\n\nThis action cannot be undone and will also delete all associated comments.')) {
            ...
            form.method = 'POST';
            form.action = 'functions/del_post.php';
