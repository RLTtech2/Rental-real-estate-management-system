                            ...
                            <div class="row">
                                <div class="col-sm-12 col-xs-12">
                                    <form action="new-payment.php" method="post">
                                        ...
                                        <div class="form-group">
                                            <label for="mpesa">MPESA CODE <span style="color:darkorange;">*</span>: </label>
                                            <div class="input-group">
                                                <div class="input-group-addon"><i class="fa fa-usd"></i></div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <textarea required name="comment" id="comment" cols="6" placeholder="e.g. Full Rent amount!" style="width:100%;"></textarea>
                                            </div>
                                        </div>
